...
* category[ilcore].coding.system = "http://terminology.hl7.org/CodeSystem/condition-category"
* category[ilcore].coding.code = #encounter-diagnosis
* category[ilcore].coding.display = "Encounter Diagnosis"
* category[szmc].coding.system = "http://fhir.szmc.org.il/cs/szmc-condition-encounter-stage"
* category[szmc].coding.code = #2
* category[szmc].coding.display = "מעקב\\שחרור"
